...
if __name__ == "__main__":
    ...
    parser.add_argument("--clean", "-r", dest="clean", action="store_true", help="Set very small pixel values to No Data. Helpful to clean edge artifacts of granules processed before IPF version 2.90.")
